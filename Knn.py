...
modelSeparate = KNeighborsClassifier(n_neighbors=50)
modelSeparate.fit(imagesa,labels)
modelSum = KNeighborsClassifier(n_neighbors=50) #trecho obtido no site https://www.datacamp.com/community/tutorials/k-nearest-neighbor-classification-scikit-learn
modelSum.fit(features,labels)


print('Making predictions based on 50 Nearest Neighbors...')
